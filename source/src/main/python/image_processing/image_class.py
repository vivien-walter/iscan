...
from image_processing.corrections import correctSignedBits, contrastCorrection, convertDark2Bright
...
class ImageArrays:
    def __init__(self, image_array):
        ...
        self.display_base = np.copy(image_array)
...
class ImageCollection:
    ...
    def rescaleForDisplay(self):
        ...
        self.image.display = contrastCorrection(self.image.display_base, 1.0, limits=self.contrast_limits)
    ...
    def rescaleTest(self, pv_limits=None):
        ...
        # Apply the contrast correction
        preview_display = contrastCorrection(self.image.display_base[ self.frame ], 1.0, limits=pv_limits)
    ...
    # -------------------------------------
    # Convert the dark spots to bright ones
    def dark2BrightDisplay(self, median=True):
        ...
        # Correct the stack
        self.image.display_base = convertDark2Bright(self.image.source, median=median)
    ...
    # ----------------------------------------------------
    # Display a preview conversion of dark to bright spots
    def dark2BrightTest(self, correction=False, median=True):
        ...
        if correction:
            preview_display = convertDark2Bright(self.image.source[ self.frame ], median=median)
