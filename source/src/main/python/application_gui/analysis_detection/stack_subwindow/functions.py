...
class stackDetectionFunctions(object):
    ...
    def initialiseSettings(self):
        ...
        # Get the value for the filter stubs entry
        set_filter_stubs = self.detection_session.filter_stubs
        if set_filter_stubs > n_frames:
            set_filter_stubs = n_frames
        self.filterStubsEntry.setText( str(set_filter_stubs) )
