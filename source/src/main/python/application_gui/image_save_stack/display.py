...
from application_gui.image_save_stack.functions import saveImageStackFunctions

##-\-\-\-\-\-\-\-\-\-\-\-\-\-\
## WINDOW FOR READING METADATA
##-/-/-/-/-/-/-/-/-/-/-/-/-/-/

class saveImageStackWindow(qtw.QMainWindow, saveImageStackFunctions):
    def __init__(self, parent, image_class=None):
        super(saveImageStackWindow, self).__init__(parent)
        ...
        self.setWindowTitle("Save Stack...")
    ...
    def createSaveFileDisplay(self, parentWidget):
        ...
        self.formatComboBox.addItems(['Tiff','Gif'])
