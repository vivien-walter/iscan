...
class ImageCorrectionProgressBarWindow(qtw.QMainWindow):
    def __init__(self, parent):
        super(ImageCorrectionProgressBarWindow, self).__init__(parent)
    ...
    def createProgressDisplay(self, parentWidget):
        ...
        self.progressTopLabel = CLabel('Image correction in progress.')
