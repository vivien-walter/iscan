...
class menuBar (menuBarFileFunctions, menuBarProcessFunctions, menuBarAnalyzeFunctions, menuBarToolsFunctions, menuBarWindowFunctions, menuBarHelpFunctions):
    ...
    def createFileMenu(self):
        ...
        #self.fileMenu.saveWholeStack.connect(self.callBackgroundCorrection)
        self.fileMenu.saveAsSubMenu.addAction(self.fileMenu.saveWholeStack)

        # Avi...
        self.fileMenu.saveAsAvi = qtw.QAction("AVI...", self.parent)
        #self.fileMenu.saveAsAvi.connect(self.callBackgroundCorrection)
    ...
    def createProcessMenu(self):
        ...
        # Crop an image
        self.processMenu.cropImageButton = qtw.QAction("Crop", self.parent)
        ...
        self.processMenu.addAction(self.processMenu.cropImageButton)
    ...
    def createAnalyzeMenu(self):
        ...
        self.analyzeMenu.centerCropButton = qtw.QAction("Center and Crop...", self.parent)
        self.analyzeMenu.centerCropButton.setStatusTip("Center and crop the image around the selected path.")
        self.analyzeMenu.centerCropButton.triggered.connect(self.callCenterCropWindow)
        self.analyzeMenu.addAction(self.analyzeMenu.centerCropButton)
        ...
        # Analyse the properties of the signals
        self.analyzeMenu.getDiffusitivityButton = qtw.QAction("Diffusitivity", self.parent)
        self.analyzeMenu.getDiffusitivityButton.setStatusTip("Measure the diffusitivity of the tracked particles.")
        #self.analyzeMenu.getDiffusitivityButton.triggered.connect(self.callSignalAnalysisWindow)
        #self.analyzeMenu.addAction(self.analyzeMenu.getDiffusitivityButton)
